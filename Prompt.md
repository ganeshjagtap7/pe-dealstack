...
keep all original data as it is of the file ,  just add new lines to it dont make any changes to previous data in file. 
Update the memmory.md file use it as memmory for claude !
