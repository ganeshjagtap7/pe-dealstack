...
export const VDRApp: React.FC = () => {
  ...
  const handleExtractFinancials = useCallback(async (file: VDRFile) => {
    if (!dealId) {
      showToast('No deal context — cannot extract financials', 'error');
      return;
    }
      ...
      <main className="flex-1 flex flex-col min-w-0 bg-slate-50 relative">
        ...
        {activeFolderId || isSearching ? (
          <FileTable
            ...
            onExtractFinancials={dealId ? handleExtractFinancials : undefined}
