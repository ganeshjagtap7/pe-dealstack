 ...
 * Modal template & file helpers loaded from js/docPreview-modal.js
 */

/* global getDocFileExtension, getDocFileIcon, getDocFileColor, createDocPreviewModal */
...
window.PEDocPreview = (function() {
    ...
    // Delegate to globals from docPreview-modal.js
    function getFileExtension(filename) { return getDocFileExtension(filename); }
    function getFileIcon(filename) { return getDocFileIcon(filename); }
    function getFileColor(filename) { return getDocFileColor(filename); }

    // Create modal container (delegates to global, adds close handlers)
    function createModal(title, filename) {
        const modal = createDocPreviewModal(title, filename);
