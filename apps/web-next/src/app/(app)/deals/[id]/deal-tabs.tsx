    ...
    <div className="flex flex-wrap gap-2 px-4 pt-3 pb-2 border-t border-border-subtle bg-surface-card">
      {prompts.map((p) => (
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2.5 text-left text-sm font-medium rounded-full border transition-all cursor-pointer hover:shadow-sm"
        ...
        >
          <span className="material-symbols-outlined text-[18px] shrink-0" style={{ color: "#003366" }}>{p.icon}</span>
