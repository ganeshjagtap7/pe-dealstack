        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-border-subtle px-3 py-2 text-sm focus:border-primary focus:ring-1 focus:ring-primary/30"
            />
          </div>
          <div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full rounded-lg border border-border-subtle px-3 py-2 text-sm resize-none focus:border-primary focus:ring-1 focus:ring-primary/30"
            />
          </div>
